  ...
  return (
    <>
      ...
      <p>
        ...
        like traveling and making new friends, and I'd rather go to dinner with
        them, than going to parties and loud places. I love to have deep
      ...
      <p>
        ...
        applications, and even small videogames on Unity. I like to have a full
        picture of the project I'm going to start before writing the first lines
      ...
      <p>
        ...
        and finally Python and JavaScript. I consider myself very good using the
